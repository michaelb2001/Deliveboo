<template>
  <div class="main-container">
      ...
      <div class="users-box">
        ...
        <div v-else-if="load" class="users-box">
  ...
  .type-box{
    ...
    .all-types{
      ...
      .type{
        ...
        &:hover{
          input:not(:checked) + .new-checkbox{
